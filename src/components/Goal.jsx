    ...
    <section>
      <div className="bg-black py-10">
        ...
        <div className="flex md:flex-row flex-col gap-20 justify-center p-4 items-center">
          <a href="/workrecom?wo=strength" class="block relative rounded-md overflow-hidden transition-transform hover:scale-110 hover:-translate-x-2 hover:-translate-y-2">
          ...
          <a href="/workrecom?wo=lose_fat" className="block bg-[#354C2F] rounded-md transition-transform hover:scale-110 hover:-translate-x-2 hover:-translate-y-2">
